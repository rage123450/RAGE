...
//#ifdef SERV_SELECT_UNIT_PACKET_DIVISION
    ...
    EGS_SELECT_UNIT_6_NOT(47),
    EGS_SELECT_UNIT_7_NOT(48),
    EGS_SELECT_UNIT_8_NOT(49),
//#endif SERV_SELECT_UNIT_PACKET_DIVISION
    //}

    //{{ 2010. 01. 04  최육사	인벤토리 기능개선
    EGS_GET_MY_INVENTORY_REQ(50),
    EGS_GET_MY_INVENTORY_ACK(51),
    EGS_SELECT_UNIT_INVENTORY_INFO_NOT(52),
    //}}
    ...
    EGS_ENTER_EQUIP_SHOP_REQ(72),
    EGS_ENTER_EQUIP_SHOP_ACK(73),

    EGS_ENTER_NPC_HOUSE_REQ(74),
    EGS_ENTER_NPC_HOUSE_ACK(75),

    //{{ 2008. 11. 25  최육사
    EGS_OPEN_PVP_ROOM_LIST_REQ(76),
    EGS_OPEN_PVP_ROOM_LIST_ACK(77),
    //}}

    //{{ 2008. 11. 25  최육사
    EGS_CHANGE_PVP_ROOM_LIST_REQ(78),
    EGS_CHANGE_PVP_ROOM_LIST_ACK(79),

    EGS_INVITE_PVP_ROOM_REQ(80),
    EGS_INVITE_PVP_ROOM_ACK(81),
    EGS_INVITE_PVP_ROOM_NOT(82),
    //}}

    EGS_ROOM_LIST_REQ(83),
    EGS_ROOM_LIST_ACK(84),

    EGS_SQUARE_LIST_REQ(),
    EGS_SQUARE_LIST_ACK(),

    //{{ 2008. 11. 26  최육사	파티 리스트
    EGS_PARTY_LIST_REQ(85),
    EGS_PARTY_LIST_ACK(86),
    //}}

    //////////////////////////////////////////////////////////////////////////
    // dummy packet enum
    EGS_GOOD_JOB_6_REQ(87),
    EGS_GOOD_JOB_7_REQ(88),
    EGS_GOOD_JOB_8_REQ(89),
    EGS_GOOD_JOB_9_REQ(90),
    EGS_GOOD_JOB_10_REQ(91),
    //////////////////////////////////////////////////////////////////////////

    EGS_CREATE_ROOM_REQ(92),
    EGS_CREATE_ROOM_ACK(93),

    EGS_CREATE_TUTORIAL_ROOM_REQ(94),
    EGS_CREATE_TUTORIAL_ROOM_ACK(95),

    EGS_JOIN_ROOM_REQ(96),
    EGS_JOIN_ROOM_ACK(97),
    EGS_JOIN_ROOM_NOT(98),

    EGS_JOIN_SQUARE_REQ(),
    EGS_JOIN_SQUARE_ACK(),
    EGS_JOIN_SQUARE_NOT(),

    EGS_QUICK_JOIN_REQ(99),
    EGS_QUICK_JOIN_ACK(100),

    EGS_LEAVE_ROOM_REQ(101),
    EGS_LEAVE_ROOM_ACK(102),
    EGS_LEAVE_ROOM_NOT(103),

    EGS_LEAVE_SQUARE_REQ(),
    EGS_LEAVE_SQUARE_ACK(),
    EGS_LEAVE_SQUARE_NOT(),

    EGS_LEAVE_GAME_REQ(104),
    EGS_LEAVE_GAME_ACK(105),
    EGS_LEAVE_GAME_NOT(106),

    EGS_BAN_USER_REQ(107),
    EGS_BAN_USER_ACK(108),
    EGS_BAN_USER_NOT(109),

    EGS_CHANGE_TEAM_REQ(110),
    EGS_CHANGE_TEAM_ACK(111),
    EGS_CHANGE_TEAM_NOT(112),

    EGS_CHANGE_READY_REQ(113),
    EGS_CHANGE_READY_ACK(114),
    EGS_CHANGE_READY_NOT(115),

    EGS_CHANGE_PITIN_REQ(116),	//방안에서 내정보창에 들어갔을때..
    EGS_CHANGE_PITIN_ACK(117),
    EGS_CHANGE_PITIN_NOT(118),

    EGS_CHANGE_MAP_REQ(119),
    EGS_CHANGE_MAP_ACK(120),
    EGS_CHANGE_MAP_NOT(121),

    EGS_CHANGE_SLOT_OPEN_REQ(122),
    EGS_CHANGE_SLOT_OPEN_ACK(123),
    EGS_CHANGE_SLOT_OPEN_NOT(124),

    EGS_CHANGE_PLAY_TIME_LIMIT_REQ(125),
    EGS_CHANGE_PLAY_TIME_LIMIT_ACK(126),
    EGS_CHANGE_PLAY_TIME_LIMIT_NOT(127),

    EGS_CHANGE_WINNING_NUM_KILL_REQ(128),
    EGS_CHANGE_WINNING_NUM_KILL_ACK(129),
    EGS_CHANGE_WINNING_NUM_KILL_NOT(130),

    EGS_CHAT_REQ(131),
    EGS_CHAT_ACK(132),
    EGS_CHAT_NOT(133),

    EGS_CHANGE_MOTION_REQ(134), // 在PVP房間內會一直發
    EGS_CHANGE_MOTION_ACK(135),
    EGS_CHANGE_MOTION_NOT(136),

    EGS_STATE_CHANGE_GAME_START_REQ(137), //호스트가 처음 게임 시작을 누름
    EGS_STATE_CHANGE_GAME_START_ACK(138),
    EGS_STATE_CHANGE_GAME_START_NOT(139),

    EGS_STATE_CHANGE_GAME_INTRUDE_REQ(140), //난입자가 난입 버튼을 누름
    EGS_STATE_CHANGE_GAME_INTRUDE_ACK(141),
    EGS_STATE_CHANGE_GAME_INTRUDE_NOT(142),

    EGS_GAME_LOADING_REQ(143),
    EGS_GAME_LOADING_ACK(144),
    EGS_GAME_LOADING_NOT(145),
    EGS_GAME_LOADING_ALL_UNIT_OK_NOT(146),

    EGS_GAME_P2P_CONNECT_RESULT_REQ(147),
    EGS_GAME_P2P_CONNECT_RESULT_ACK(148),

    EGS_PLAY_START_NOT(),
    EGS_INTRUDE_START_REQ(149), //난입자가 로딩(), 커넥트 끝나면
    EGS_INTRUDE_START_ACK(150), //난입자가 로딩(), 커넥트 끝나면
    EGS_INTRUDE_START_NOT(151), //난입 성공

    EGS_CURRENT_KILL_SCORE_NOT(152),
    EGS_CURRENT_TEAM_KILL_SCORE_NOT(153),

    EGS_REMAINING_PLAY_TIME_NOT(154),
    EGS_PLAY_TIME_OUT_NOT(155),

    EGS_MY_USER_UNIT_INFO_TO_SERVER_REQ(156),
    EGS_MY_USER_UNIT_INFO_TO_SERVER_ACK(157),
//    EGS_MY_USER_UNIT_INFO_TO_SERVER_NOT(),	//던전에서 정보수집후 STATE를 이동하기위해 동기화

    //{{ 2008. 9. 19  최육사	통계
    EGS_DUNGEON_PLAY_INFO_TO_SERVER_NOT(158),
    //}}

    EGS_USER_UNIT_RE_BIRTH_POS_REQ(159),
    EGS_USER_UNIT_RE_BIRTH_POS_ACK(160),

    //EGS_USER_UNIT_RE_BIRTH_REQ(),
    //EGS_USER_UNIT_RE_BIRTH_ACK(),
    EGS_USER_UNIT_RE_BIRTH_NOT(161),

    EGS_USER_UNIT_CREATE_REQ(162),
    EGS_USER_UNIT_CREATE_ACK(163),
    EGS_USER_UNIT_CREATE_NOT(164),

    EGS_USER_UNIT_DIE_REQ(165),
    EGS_USER_UNIT_DIE_ACK(166),
    EGS_USER_UNIT_DIE_NOT(167),

    EGS_USER_UNIT_DIE_COMPLETE_REQ(168),
    EGS_USER_UNIT_DIE_COMPLETE_ACK(169),
    EGS_USER_UNIT_DIE_COMPLETE_NOT(170),

    EGS_NPC_UNIT_CREATE_REQ(171), //호스트가 보냄(), 몬스터 위치(), 종류(),
    EGS_NPC_UNIT_CREATE_ACK(172),
    EGS_NPC_UNIT_CREATE_NOT(173), //몬스터 UID를 추가해서 보냄

    EGS_NPC_UNIT_DIE_REQ(174), //몬스터 UID
    EGS_NPC_UNIT_DIE_ACK(175),
    EGS_NPC_UNIT_DIE_NOT(176),

    EGS_DUNGEON_STAGE_LOAD_REQ(177), //호스트가 날림(), 스테이지 번호 있음(), 몬스터 개수
    EGS_DUNGEON_STAGE_LOAD_ACK(178),
    EGS_DUNGEON_STAGE_LOAD_NOT(179), //몬스터 UID 발급

    EGS_DUNGEON_STAGE_LOAD_COMPLETE_REQ(180),
    EGS_DUNGEON_STAGE_LOAD_COMPLETE_ACK(181),
    EGS_DUNGEON_STAGE_LOAD_COMPLETE_NOT(182),

    EGS_DUNGEON_STAGE_START_NOT(183), //스테이지 번호

    EGS_DUNGEON_SUB_STAGE_OPEN_REQ(184), //호스트가 날림(), 서브 스테이지 번호
    EGS_DUNGEON_SUB_STAGE_OPEN_ACK(185),
    EGS_DUNGEON_SUB_STAGE_OPEN_NOT(186),// 다음 스테이지의 스타트 라인을 연다

    EGS_DUNGEON_SUB_STAGE_GO_NEXT_REQ(187), //내가 다음 스테이지 라인으로 넘어갔다 장막 생성
    EGS_DUNGEON_SUB_STAGE_GO_NEXT_ACK(188),
    EGS_DUNGEON_SUB_STAGE_GO_NEXT_ALL_NOT(189), //모두 넘어왔다 이전 스테이지 라인을 끈다

    EGS_DUNGEON_SUB_STAGE_LOAD_COMPLETE_REQ(190), //몬스터 생성이 끝나면 각자 날림
    EGS_DUNGEON_SUB_STAGE_LOAD_COMPLETE_ACK(191),

    EGS_DUNGEON_SUB_STAGE_START_NOT(192), //장막 열림

    EGS_END_GAME_REQ(193), //호스트만), 던전에서 이겼을 때
    EGS_END_GAME_ACK(194),
    EGS_END_GAME_NOT(195),

    EGS_END_GAME_DUNGEON_RESULT_DATA_NOT(196),
    EGS_END_GAME_PVP_RESULT_DATA_NOT(197),

    EGS_STATE_CHANGE_RESULT_REQ(198),
    EGS_STATE_CHANGE_RESULT_ACK(199),
    EGS_STATE_CHANGE_RESULT_NOT(200),
    ...
    EGS_DROP_ITEM_NOT(205),
    EGS_GET_ITEM_REQ(206),
    EGS_GET_ITEM_ACK(207),
    EGS_GET_ITEM_NOT(208),

    //{{ 2009. 5. 11  최육사	실시간아이템
    EGS_GET_ITEM_REALTIME_NOT(209),
    EGS_GET_ITEM_TEMP_INVENTORY_NOT(210),
    EGS_GET_TEMP_ITEM_REQ(211),
    EGS_GET_TEMP_ITEM_ACK(212),
    EGS_DELETE_TEMP_ITEM_REQ(213),
    EGS_DELETE_TEMP_ITEM_ACK(214),
    //}}

    EGS_UPDATE_UNIT_INFO_NOT(215),

    EGS_REFRESH_ROOM_REQ(216),
    EGS_REFRESH_ROOM_ACK(217),

    EGS_NOTIFY_MSG_REQ(218),
    EGS_NOTIFY_MSG_NOT(219),

    EGS_ADMIN_SERVER_STATUS_REQ(220),
    EGS_ADMIN_SERVER_STATUS_ACK(221),

    EGS_CLIENT_QUIT_REQ(222),
    EGS_CLIENT_QUIT_ACK(223),

    //
    //

    EGS_ADMIN_MODIFY_UNIT_LEVEL_REQ(226), // not sure
    EGS_ADMIN_MODIFY_UNIT_LEVEL_ACK(227),

    EGS_CHANGE_OPTION_PLAY_GUIDE_REQ(228),
    EGS_CHANGE_OPTION_PLAY_GUIDE_ACK(229),

    //
    //

    EGS_BUY_ED_ITEM_REQ(232),
    EGS_BUY_ED_ITEM_ACK(233),

    EGS_SELL_ED_ITEM_REQ(234),
    EGS_SELL_ED_ITEM_ACK(235),

    EGS_NEW_QUEST_REQ(236),
    EGS_NEW_QUEST_ACK(237),
    EGS_NEW_QUEST_NOT(238),

    EGS_UPDATE_QUEST_REQ(239),
    EGS_UPDATE_QUEST_ACK(240),
    EGS_UPDATE_QUEST_NOT(241),

    EGS_QUEST_COMPLETE_REQ(242),
    EGS_QUEST_COMPLETE_ACK(243),

    EGS_ADMIN_QUEST_COMPLETE_REQ(244),		//운영자 이상의 유저가 테스트를 하기위해 퀘스트 무조건 완료처리 하기위한..

    EGS_QUEST_COMPLETE_NOT(245),	// 선택보상 & 일반보상 처리후 유저정보 처리는 이패킷으로 한다.

    //{{ 2012. 04. 17	최육사	퀘스트 조건 마을 입장
//#ifdef SERV_ENTER_FIELD_QUEST_CLEAR
    EGS_ALL_COMPLETED_QUEST_COMPLETE_REQ(246),
    EGS_ALL_COMPLETED_QUEST_COMPLETE_ACK(247),
//#endif SERV_ENTER_FIELD_QUEST_CLEAR
    //}}

    EGS_GIVE_UP_QUEST_REQ(248),
//#ifdef SERV_GATHER_GIVE_UP_QUEST
    EGS_GATHER_GIVE_UP_QUEST_REQ(249),
...
//    EGS_SQUARE_UNIT_SYNC_DATA_NOT(286),
    ...
    EGS_GET_SKILL_REQ(286),
    EGS_GET_SKILL_ACK(287),

    EGS_CHANGE_SKILL_SLOT_REQ(288),
    EGS_CHANGE_SKILL_SLOT_ACK(289),
    EGS_CHANGE_SKILL_SLOT_NOT(290),

    EGS_ADMIN_CHANGE_SKILL_POINT_REQ(291),
    EGS_ADMIN_CHANGE_SKILL_POINT_ACK(292),

    EGS_ADMIN_INIT_SKILL_TREE_REQ(293),
    EGS_ADMIN_INIT_SKILL_TREE_ACK(294),

    EGS_INIT_SKILL_TREE_REQ(295),
    EGS_INIT_SKILL_TREE_ACK(296),

    // 스킬 되돌리기
    EGS_RESET_SKILL_REQ(297),
    EGS_RESET_SKILL_ACK(298),

    EGS_UPDATE_CASH_SKILL_POINT_NOT(299),			// 캐시스킬포인트를 구매하거나 사용했을 때 받는 패킷
    EGS_EXPIRE_CASH_SKILL_POINT_NOT(300),			// 캐시 스킬포인트가 만료 되었을 때

    EGS_EXPAND_SKILL_SLOT_NOT(301),					// 스킬 슬롯 B 확장 아이템을 샀을 때 가져왔을 때
    EGS_EXPIRE_SKILL_SLOT_NOT(302),					// 스킬 슬롯 B 확장 기간만료 되었을 때

    //{{ 2009. 8. 4  최육사		봉인스킬
    EGS_UNSEAL_SKILL_NOT(303),						// 스킬 봉인 해제 통보
    //}}

    EGS_ADMIN_KICK_USER_REQ(304),
    EGS_ADMIN_KICK_USER_ACK(305),
    ELG_ADMIN_KICK_USER_REQ(306),
    ELG_ADMIN_KICK_USER_ACK(307),
...
/*    EGS_CREATE_PARTY_REQ(309),
    ...
    //// 파티장이 초대하는경우.
    EGS_INVITE_PARTY_REQ(308),
    EGS_INVITE_PARTY_ACK(309),
    EGS_INVITE_PARTY_NOT(310),

    EGS_INVITE_PARTY_REPLY_NOT(311),
    EGS_INVITE_PARTY_DENY_NOT(312),				// 파티장이 다른 사람에게 파티 참가 신청한 후 time out 됐을 때 파티장이 받는 패킷

    EGS_JOIN_PARTY_NOT(313),
    EGS_CLOSE_PARTY_NOT(314),

    EGS_UPDATE_PARTY_USER_INFO_NOT(315),
    ////{{ 2009. 3. 31  최육사	파티유저
    EGS_UPDATE_PARTY_UID_NOT(316),
    ////}}
    ...
    //// 게임 시작
    EGS_PARTY_GAME_START_REQ(326),
    EGS_PARTY_GAME_START_ACK(327),
    EGS_PARTY_GAME_START_NOT(328),

    EGS_PARTY_GAME_START_OPINION_CHECK_NOT(329),
    EGS_PARTY_GAME_START_OPINION_CHECK_REPLY_NOT(330),

    EGS_PARTY_GAME_START_FAILED_NOT(331),

    //// 파티장 변경.
    EGS_PARTY_CHANGE_HOST_REQ(332),
    EGS_PARTY_CHANGE_HOST_ACK(333),
    EGS_PARTY_CHANGE_HOST_NOT(334),

    //// 파티원 강퇴.
    EGS_PARTY_BAN_USER_REQ(335),
    EGS_PARTY_BAN_USER_ACK(336),
    EGS_PARTY_BAN_USER_NOT(337),

    //// 던전게임 아이템 먹는 방식 결정.
    EGS_PARTY_CHANGE_GET_ITEM_TYPE_REQ(338),
    EGS_PARTY_CHANGE_GET_ITEM_TYPE_ACK(339),
    EGS_PARTY_CHANGE_GET_ITEM_TYPE_NOT(340),

    //// 던전게임 아이템 먹는 방식 결정.
    EGS_PARTY_CHANGE_NUM_OF_PER_REQ(341),
    EGS_PARTY_CHANGE_NUM_OF_PER_ACK(342),
    EGS_PARTY_CHANGE_NUM_OF_PER_NOT(343),

    ////{{ 2009. 4. 1  최육사		파티렙제
    EGS_PARTY_LIMIT_LEVEL_REQ(344),
    EGS_PARTY_LIMIT_LEVEL_ACK(345),
    EGS_PARTY_LIMIT_LEVEL_NOT(346),
    ////}}

    //// 파티 유저 밴
    EGS_BAN_PARTY_USER_REQ(347),
    EGS_BAN_PARTY_USER_ACK(348),
    EGS_BAN_PARTY_USER_NOT(349),

    EGS_RESURRECT_TO_CONTINUE_DUNGEON_REQ(350),
    EGS_RESURRECT_TO_CONTINUE_DUNGEON_ACK(351),
    EGS_RESURRECT_TO_CONTINUE_DUNGEON_NOT(352),

    // 블랙리스트
    EGS_NEW_BLACKLIST_USER_REQ(353),
    EGS_NEW_BLACKLIST_USER_ACK(354),
    EGS_DEL_BLACKLIST_USER_REQ(355),
    EGS_DEL_BLACKLIST_USER_ACK(356),

    EGS_UPDATE_COMMUNITY_OPTION_REQ(357),
    EGS_UPDATE_COMMUNITY_OPTION_ACK(358),

    EGS_SKIP_CONTINUE_DUNGEON_NOT(359),

    EGS_CHECK_SUM_REQ(360),
    EGS_CHECK_SUM_ACK(361),

    //korea nexon msg
    EGS_KNM_REQUEST_NEW_FRIEND_INFO_REQ(362),
    EGS_KNM_REQUEST_NEW_FRIEND_INFO_ACK(363),
    EGS_KNM_INVITE_REQ(364),
    EGS_KNM_INVITE_ACK(365),
    EGS_KNM_INVITE_NOT(366),
    EGS_KNM_INVITE_RESULT_NOT(367),
    EGS_KNM_TOGETHER_REQ(368),
    EGS_KNM_TOGETHER_ACK(369),

    // 개인 거래
    EGS_REQUEST_TRADE_REQ(370),
    EGS_REQUEST_TRADE_ACK(371),

    EGS_REQUEST_TRADE_NOT(372),
    EGS_REQUEST_TRADE_REPLY_NOT(373),
    EGS_REQUEST_TRADE_DENY_NOT(374),

    EGS_CREATE_TRADE_NOT(375),

    EGS_BREAK_TRADE_REQ(376),
    EGS_BREAK_TRADE_ACK(377),
    EGS_BREAK_TRADE_NOT(378),

    EGS_TRADE_USER_INFO_NOT(379),
    EGS_JOIN_TRADE_NOT(380),

    EGS_UPDATE_TRADE_ITEM_REQ(381),
    EGS_UPDATE_TRADE_ITEM_ACK(382),
    EGS_UPDATE_TRADE_ITEM_NOT(383),

    EGS_UPDATE_TRADE_ED_REQ(384),
    EGS_UPDATE_TRADE_ED_ACK(385),
    EGS_UPDATE_TRADE_ED_NOT(386),

    EGS_OFFER_TRADE_REQ(387),
    EGS_OFFER_TRADE_ACK(388),
    EGS_OFFER_TRADE_NOT(389),

    EGS_APPROVE_TRADE_REQ(390),
    EGS_APPROVE_TRADE_ACK(391),
    EGS_APPROVE_TRADE_NOT(392),

    EGS_TRADE_COMPLETE_NOT(393),

    EGS_REPAIR_ITEM_REQ(394/*414*/),
    EGS_REPAIR_ITEM_ACK(395/*415*/),
    EGS_REPAIR_ITEM_NOT(396/*416*/),
    ...
    //게임중 추가 능력치 적용
    EGS_ADD_ON_STAT_REQ(411),
    EGS_ADD_ON_STAT_ACK(412),
    EGS_ADD_ON_STAT_NOT(413),

    EGS_APPLY_COUPON_REQ(414),
    EGS_APPLY_COUPON_ACK(415),

    EGS_PURCHASED_CASH_ITEM_LIST_REQ(416),
    EGS_PURCHASED_CASH_ITEM_LIST_ACK(417),

    EGS_GET_PURCHASED_CASH_ITEM_REQ(418),
    EGS_GET_PURCHASED_CASH_ITEM_ACK(419),

    EGS_FRAME_AVERAGE_REQ(420),
    EGS_FRAME_AVERAGE_ACK(421),

    EGS_CHANGE_NICK_NAME_REQ(422),
    EGS_CHANGE_NICK_NAME_ACK(423),

    EGS_ADMIN_CHANGE_SPIRIT_REQ(424),
    EGS_ADMIN_CHANGE_SPIRIT_ACK(425),

    EGS_ADMIN_SET_PC_BANG_REQ(426),
    EGS_ADMIN_SET_PC_BANG_ACK(427),

    EGS_ADMIN_CHANGE_VSPOINT_REQ(428),
    EGS_ADMIN_CHANGE_VSPOINT_ACK(429),

    EGS_CHECK_BALANCE_REQ(430),
    EGS_CHECK_BALANCE_ACK(431),

    //////////////////////////////////////////////////////////////////////////
    EGS_CREATE_PERSONAL_SHOP_REQ(432),
    EGS_CREATE_PERSONAL_SHOP_ACK(433),

    EGS_REG_PERSONAL_SHOP_ITEM_REQ(434),
    EGS_REG_PERSONAL_SHOP_ITEM_ACK(435),

    EGS_BUY_PERSONAL_SHOP_ITEM_REQ(436),
    EGS_BUY_PERSONAL_SHOP_ITEM_ACK(437),
    EGS_BUY_PERSONAL_SHOP_ITEM_COMPLETE_NOT(438),

    EGS_UPDATE_PERSONAL_SHOP_ITEM_INFO_NOT(439),

    EGS_BREAK_PERSONAL_SHOP_REQ(440),
    EGS_BREAK_PERSONAL_SHOP_ACK(441),
    EGS_BREAK_PERSONAL_SHOP_NOT(442),

    EGS_JOIN_PERSONAL_SHOP_REQ(443),
    EGS_JOIN_PERSONAL_SHOP_ACK(444),

    EGS_LEAVE_PERSONAL_SHOP_REQ(445),
    EGS_LEAVE_PERSONAL_SHOP_ACK(446),

    EGS_UPDATE_SQUARE_PERSONAL_SHOP_INFO_NOT(447),
    //Personal Shop packet
    //////////////////////////////////////////////////////////////////////////

    EGS_ADMIN_CHANGE_UNIT_CLASS_REQ(448),
    EGS_ADMIN_CHANGE_UNIT_CLASS_ACK(449),

    EGS_CHANGE_TRADE_NOT(450),
    ...
    // 우체국 信箱
    EGS_GET_POST_LETTER_LIST_REQ(458),
    EGS_GET_POST_LETTER_LIST_ACK(459),
    EGS_NEW_POST_LETTER_INFO_NOT(460),
    EGS_SEND_LETTER_REQ(461),
    EGS_SEND_LETTER_ACK(462),
    EGS_RECEIVE_LETTER_NOT(463),
    EGS_READ_LETTER_REQ(464),
    EGS_READ_LETTER_ACK(465),
    EGS_GET_ITEM_FROM_LETTER_REQ(466),
    EGS_GET_ITEM_FROM_LETTER_ACK(467),
    EGS_DELETE_LETTER_REQ(468),
    EGS_DELETE_LETTER_ACK(469),
    EGS_RENEWAL_LETTER_REQ(470),
    EGS_RENEWAL_LETTER_ACK(471),
    ...
    // 장바구니
    EGS_GET_WISH_LIST_REQ(495),
    EGS_GET_WISH_LIST_ACK(496),
    EGS_MODIFY_WISH_LIST_REQ(497),
    EGS_MODIFY_WISH_LIST_ACK(498),

    //{{ 2008. 5. 21  최육사  체험ID 제한
    EGS_GUEST_USER_LIMIT_LEVEL_NOT(499),
    //}}

    EGS_AGREE_HACK_USER_REQ(500),
    EGS_AGREE_HACK_USER_ACK(501),
    EGS_REPORT_HACK_USER_NOT(502),

    //{{ 2008. 6. 16  최육사  넥슨빌링 패키지 픽업
    EGS_GET_PURCHASED_PACKAGE_CASH_ITEM_REQ(503),
    EGS_GET_PURCHASED_PACKAGE_CASH_ITEM_ACK(504),
    //}}

    //{{ 2008. 6. 16  최육사  던전 컨티뉴 시간 멈추기
    EGS_STOP_DUNGEON_CONTINUE_TIME_REQ(505),
    EGS_STOP_DUNGEON_CONTINUE_TIME_ACK(506),
    //}}

    //{{ 2008. 6. 20  최육사  캐쉬 인벤 선물 확인
    EGS_NEW_PRESENT_CASH_INVENTORY_NOT(507),
    EGS_CHECK_PRESENT_CASH_INVENTORY_NOT(508),
    EGS_PRESENT_MESSAGE_TO_RECEIVER_NOT(509),
    //}}
    ...
    EGS_GET_POST_BLACK_LIST_REQ(525),
    EGS_GET_POST_BLACK_LIST_ACK(526),
    EGS_NEW_POST_BLACK_LIST_REQ(527),
    EGS_NEW_POST_BLACK_LIST_ACK(528),
    EGS_DEL_POST_BLACK_LIST_REQ(529),
    EGS_DEL_POST_BLACK_LIST_ACK(530),
    //}}

    //{{ 2008. 10. 6  최육사	타이틀
    EGS_EQUIP_TITLE_REQ(531),
    EGS_EQUIP_TITLE_ACK(532),
    EGS_TITLE_EXPIRATION_NOT(533),
    EGS_NEW_MISSION_NOT(534),
    EGS_UPDATE_MISSION_NOT(535),
    EGS_REWARD_TITLE_NOT(536),
    //}}

    //{{ 2008. 10. 9  최육사	아이템사용
    EGS_USE_ITEM_IN_INVENTORY_REQ(537),
    EGS_USE_ITEM_IN_INVENTORY_ACK(538),
    //}}

    //{{ 2008. 10. 24  최육사	타이틀 치트
    EGS_ADMIN_GET_TITLE_CHEAT_REQ(539),
    EGS_ADMIN_GET_TITLE_CHEAT_ACK(540),
    //}}

    //{{ 2008. 10. 29  최육사	던전입장불가
    EGS_DUNGEON_REQUIRE_ITEM_MESSAGE_NOT(541),
    //}}

    //{{ 2008. 12. 14  최육사	캐릭터 슬롯 확장
    EGS_EXPAND_CHAR_SLOT_NOT(542),
    //}}

    //{{ 2008. 12. 19  최육사	아이템 복구
    EGS_RESTORE_ITEM_REQ(543),
    EGS_RESTORE_ITEM_ACK(544),
    //}}

    //{{ 2008. 12. 25  최육사	부여
    EGS_ENCHANT_ATTACH_ITEM_REQ(543),
    EGS_ENCHANT_ATTACH_ITEM_ACK(544),
    //}}

    //{{ 2008. 11. 18  최육사	아이템 교환
    EGS_ITEM_EXCHANGE_REQ(545),
    EGS_ITEM_EXCHANGE_ACK(546),
    //}}

    //{{ 2008. 11. 4  최육사	광장 개편
    EGS_STATE_CHANGE_FIELD_REQ(547),
    EGS_STATE_CHANGE_FIELD_ACK(548),
    EGS_FIELD_LOADING_COMPLETE_REQ(549),
    EGS_FIELD_LOADING_COMPLETE_ACK(550),
    EGS_LEAVE_FIELD_NOT(551),

    EGS_CHANGE_USER_LIST_IN_SECTOR_NOT(552),
    EGS_FIELD_UNIT_SYNC_DATA_NOT(553),
    //}}

    ETR_REG_UID(554),	// TCP RELAY 접속후 UID 전송.
    ETR_UNIT_DISCONNECT(555),
    EGS_FIELD_UNIT_SYNC_DATA_BROAD_NOT(556),

    //{{ 2009. 1. 13  최육사	커뮤니티 유저 리스트
    EGS_COMMUNITY_USER_LIST_REQ(557),
    EGS_COMMUNITY_USER_LIST_ACK(558),
    //}}

    //{{ 2008. 12. 9  최육사	친구 리스트
    EGS_OPTION_UPDATE_REQ(559),
    EGS_OPTION_UPDATE_ACK(560),
    //}}

    //{{ 2009. 2. 13  최육사	채널 이동
    EGS_DISCONNECT_FOR_SERVER_SELECT_REQ(561),
    EGS_DISCONNECT_FOR_SERVER_SELECT_ACK(562),
    EGS_DISCONNECT_FOR_CHANNEL_CHANGE_REQ(563),
    EGS_DISCONNECT_FOR_CHANNEL_CHANGE_ACK(564),
    ECH_DISCONNECT_REQ(565),
    ECH_DISCONNECT_ACK(566),
    //}}

    //{{ 2009. 4. 7  최육사		친구정보
    EGS_UPDATE_FRIEND_INFO_REQ(567),
    EGS_UPDATE_FRIEND_INFO_ACK(568),
    //}}

    //{{ 2009. 4. 8  최육사		닉네임 변경
    EGS_DELETE_NICK_NAME_SUCCESS_NOT(569),
    //}}

    //{{ 2009.05.06.hoons.캐릭터 메신져 아이디 요청.
    EGS_GET_MY_MESSENGER_SN_REQ(570),
    EGS_GET_MY_MESSENGER_SN_ACK(571),
    //}} hoons

    //{{ 2009. 5. 8  최육사		실시간 레벨업
    EGS_CHAR_LEVEL_UP_NOT(572),
    //}}

    //{{ 2009. 5. 14  최육사	내구도 소모 개편
    EGS_DECREASE_ENDURANCE_NOT(573),
    EGS_ZERO_ENDURANCE_ITEM_IN_ROOM_NOT(574),
    EGS_DECREASE_SPIRIT_NOT(575),
    //}}

    //{{ 2009. 6. 3  최육사		확성기
    EGS_USE_MEGAPHONE_REQ(576),
    EGS_USE_MEGAPHONE_ACK(577),
    EGS_MEGAPHONE_MESSAGE_NOT(578),
    //}}

    //{{ 2009. 7. 10  최육사	사기 시스템
    EGS_PARTY_FEVER_POINT_NOT(579),
    EGS_CHANGE_PARTY_FEVER_STATE_NOT(580),
    EGS_ADMIN_INCREASE_PARTY_FEVER_POINT_NOT(581),
    //}}
    ...
    EGS_REQUEST_FRIEND_REQ(582),
    EGS_REQUEST_FRIEND_ACK(583),
    EGS_REQUEST_FRIEND_NOT(584),

    EGS_ACCEPT_FRIEND_REQ(585),
    EGS_ACCEPT_FRIEND_ACK(586),
    EGS_ACCEPT_FRIEND_NOT(587),

    EGS_DENY_FRIEND_REQ(588),
    EGS_DENY_FRIEND_ACK(589),
    EGS_DENY_FRIEND_NOT(590),

    EGS_BLOCK_FRIEND_REQ(591),
    EGS_BLOCK_FRIEND_ACK(592),
    EGS_BLOCK_FRIEND_NOT(593),

    EGS_UNBLOCK_FRIEND_REQ(594),
    EGS_UNBLOCK_FRIEND_ACK(595),
    EGS_UNBLOCK_FRIEND_NOT(596),

    EGS_DELETE_FRIEND_REQ(597),
    EGS_DELETE_FRIEND_ACK(598),
    EGS_DELETE_FRIEND_NOT(599),

    EGS_MOVE_FRIEND_REQ(600),
    EGS_MOVE_FRIEND_ACK(601),

    EGS_MAKE_FRIEND_GROUP_REQ(602),
    EGS_MAKE_FRIEND_GROUP_ACK(603),

    EGS_RENAME_FRIEND_GROUP_REQ(604),
    EGS_RENAME_FRIEND_GROUP_ACK(605),

    EGS_DELETE_FRIEND_GROUP_REQ(606),
    EGS_DELETE_FRIEND_GROUP_ACK(607),

    EGS_FRIEND_POSITION_UPDATE_NOT(608),
    ...
    ECH_VERIFY_ACCOUNT_REQ(626), // 如果帳密有除了英文數字以外的字 包頭會用ECH_VERIFY_ACCOUNT_REQ_(659)
    ECH_VERIFY_ACCOUNT_ACK(627),
    //
    EGS_ENTER_CASH_SHOP_ACK(),
    EGS_CASH_SHOP_INFO_REQ(),
    EGS_CASH_SHOP_INFO_ACK(),
    EGS_CASH_SHOP_INFO_NOT(),
    ECH_VERIFY_ACCOUNT_REQ_(),

    //////////////////////////////////////////////////////////////////////////
    //{{ 2009. 9. 17  최육사	길드 最新版的

    EGS_CREATE_GUILD_REQ(628),
    EGS_CREATE_GUILD_ACK(629),
    EGS_GUILD_INFO_NOT(630),
    EGS_GET_GUILD_USER_LIST_REQ(631),
    EGS_GET_GUILD_USER_LIST_ACK(632),
    EGS_GUILD_MEMBER_INFO_NOT(633),
    EGS_GUILD_MESSAGE_NOT(634),
    EGS_INVITE_GUILD_REQ(635),
    ECH_ENTER_CASH_SHOP_REQ(636),
    EGS_INVITE_GUILD_ACK(637),
    EGS_INVITE_GUILD_NOT(638),
    EGS_INVITE_GUILD_REPLY_REQ(639),
    EGS_INVITE_GUILD_REPLY_ACK(640),
...
//#endif SERV_GUILD_CHANGE_NAME
    ...
    //////////////////////////////////////////////////////////////////////////
    //{{ 2009. 12. 31  최육사	길드 광고 最新版的
    EGS_GET_GUILD_AD_LIST_REQ(700),
    EGS_GET_GUILD_AD_LIST_ACK(701),

    EGS_GET_GUILD_SKILL_IN_BOARD_REQ(702),
    EGS_GET_GUILD_SKILL_IN_BOARD_ACK(703),

    EGS_REGISTRATION_GUILD_AD_REQ(704),
    EGS_REGISTRATION_GUILD_AD_ACK(705),

    EGS_MODIFY_REG_GUILD_AD_REQ(706),
    EGS_MODIFY_REG_GUILD_AD_ACK(707),

    EGS_APPLY_JOIN_GUILD_REQ(708),
    EGS_APPLY_JOIN_GUILD_ACK(709),

    EGS_GET_APPLY_JOIN_GUILD_LIST_REQ(710),
    EGS_GET_APPLY_JOIN_GUILD_LIST_ACK(711),

    EGS_ACCEPT_JOIN_GUILD_REQ(712),
    EGS_ACCEPT_JOIN_GUILD_ACK(713),

    EGS_DELETE_APPLY_JOIN_GUILD_REQ(714),
    EGS_DELETE_APPLY_JOIN_GUILD_ACK(715),
    //}}
    //////////////////////////////////////////////////////////////////////////
    ...
    EGS_EXPAND_SKILL_NOTE_PAGE_NUM_NOT(733),
    EGS_REG_SKILL_NOTE_MEMO_REQ(734),
    EGS_REG_SKILL_NOTE_MEMO_ACK(735),
    //}}

    //{{ 2010. 05. 06  최육사	비밀던전 헬모드
    EGS_DUNGEON_EFFECT_REMAINING_TIME_NOT(736),
    EGS_DUNGEON_EFFECT_TIME_OUT_NOT(737),
    //}}

    //{{ 2010. 05. 06  최육사	에러 팝업
    EGS_ERROR_POPUP_NOT(738),
    //}}

    //{{ 2010. 05. 20  최육사	스크립트 파싱
    EGS_GET_CLIENT_SCRIPT_REQ(739),
    EGS_GET_CLIENT_SCRIPT_ACK(740),
    //}}

    //{{ 2010. 06. 17  최육사	오토핵 방지
    EGS_SERVER_CHECK_HACK_USER_NOT(741),
    //}}

    //{{ 2010. 7. 21  최육사	펫 시스템
    EGS_CREATE_PET_REQ(742),
    EGS_CREATE_PET_ACK(743),

    EGS_GET_PET_LIST_REQ(744),
    EGS_GET_PET_LIST_ACK(745),

    EGS_SUMMON_PET_REQ(746),
    EGS_SUMMON_PET_ACK(747),
    EGS_SUMMON_PET_NOT(748),

    EGS_COMMANDS_FOR_PETS_REQ(749),
    EGS_COMMANDS_FOR_PETS_ACK(750),
    EGS_PET_ACTION_NOT(751),

    EGS_CHANGED_PET_SATIETY_NOT(752),
    EGS_CHANGED_PET_INTIMACY_NOT(753),
    EGS_CHANGED_PET_SATIETY_INTIMACY_NOT(754),

    EGS_FEED_PETS_REQ(755),
    EGS_FEED_PETS_ACK(756),
    EGS_FIRST_FEED_PETS_NOT(757),

    EGS_SET_AUTO_FEED_PETS_REQ(758),
    EGS_SET_AUTO_FEED_PETS_ACK(759),
    EGS_AUTO_FEED_NOT(760),

    EGS_PET_EVOLUTION_REQ(761),
    EGS_PET_EVOLUTION_ACK(762),
    EGS_PET_EVOLUTION_NOT(763),

    EGS_ADMIN_CHANGE_PET_INFO_NOT(764),

    //{{ 2012. 02. 22	박세훈	펫 이름 변경권
//#ifdef SERV_PET_CHANGE_NAME
    EGS_CHANGE_PET_NAME_REQ(765),
    EGS_CHANGE_PET_NAME_ACK(766),
//#endif SERV_PET_CHANGE_NAME
    ...
    EGS_RESET_PERIOD_ITEM_NOT(767),
    //}}

    //{{ 2010. 9. 29	최육사	ED 모니터링 치트
    EGS_ADMIN_SHOW_ED_CHEAT_REQ(768),
    EGS_ADMIN_SHOW_ED_CHEAT_ACK(769),
    //}}

    //{{ 2010. 10. 13	최육사	DLL Manager
    EGS_MODULE_INFO_UPDATE_NOT(770),
    //}}
...
//#ifdef SERV_SECOND_SECURITY
    EGS_SECOND_SECURITY_INFO_NOT(805),
...
//#ifdef SERV_MACHINE_ID_BLOCK
    EGS_CHECK_MACHINE_ID_REQ(853),
    EGS_CHECK_MACHINE_ID_ACK(854),
...
//#endif SERV_SORT_CATEGORY_ITEM
    ...
    //{{ 2011. 10. 27	최육사	배틀필드 시스템 最新版的
//#ifdef SERV_BATTLE_FIELD_SYSTEM
    EGS_JOIN_BATTLE_FIELD_REQ(882),
    EGS_JOIN_BATTLE_FIELD_ACK(883),
    EGS_JOIN_BATTLE_FIELD_NOT(884),

    EGS_LEAVE_BATTLE_FIELD_NOT(885),

    EGS_BATTLE_FIELD_JOIN_USER_LOAD_COMPLETE_NOT(886),

    EGS_BATTLE_FIELD_NPC_LOAD_NOT(887),

    EGS_BATTLE_FIELD_NPC_LOAD_COMPLETE_REQ(888),
    EGS_BATTLE_FIELD_NPC_LOAD_COMPLETE_ACK(889),

    EGS_BATTLE_FIELD_NPC_P2P_SYNC_NOT(890),
...
//#endif  SERV_OPTIMIZE_ROBUST_USER_NPC_PACKET_SEND
    ...
    EGS_BATTLE_FIELD_EVENT_MESSAGE_NOT(891),

    EGS_UPDATE_BATTLE_FIELD_USER_POS_NOT(892),

    EGS_QUICK_START_DUNGEON_GAME_REQ(893),				// 구성된 파티로 또는 혼자서 던전 게임 바로 시작!
    EGS_QUICK_START_DUNGEON_GAME_ACK(894),

    EGS_UPDATE_MOVE_TO_PARTY_MEMBER_INFO_NOT(895),		// 파티원에게 이동하는 버튼 활성화 여부

    // 자동 파티
    EGS_AUTO_PARTY_DUNGEON_GAME_REQ(896),				// 구성된 파티로 또는 혼자서 자동 파티 신청!
    EGS_AUTO_PARTY_DUNGEON_GAME_ACK(897),
    EGS_REG_AUTO_PARTY_WAIT_LIST_SUCCESS_NOT(898),		// 자동 파티 신청 성공!! 파티UI가 자동 파티UI로 변경된다.

    EGS_CANCEL_AUTO_PARTY_MAKING_REQ(899),				// 자동 파티 등록 해제 요청
    EGS_CANCEL_AUTO_PARTY_MAKING_ACK(900),

    EGS_UNREG_AUTO_PARTY_WAIT_LIST_NOT(901),				// 자동 파티 등록 해제!! 파티UI가 원래 파티UI로 변경된다.

    EGS_AUTO_PARTY_MAKING_SUCCESS_NOT(902),				// 자동 파티 매칭 성공! 던전 게임을 시작할지 말지를 물어보는 팝업이 뜬다!
    EGS_AUTO_PARTY_MAKING_SUCCESS_REPLY_NOT(903),		// 팝업의 수락&거절에 대한 응답을 담아 서버로 보내는 패킷

    EGS_AUTO_PARTY_CLOSE_NOT(904),						// 자동 파티 매칭이 닫히는 경우 오는 패킷(), 떠있는 팝업을 지우고 왜 매칭이 실패했는지 에러 팝업을 띄운다.

    EGS_REGROUP_PARTY_NOT(905),							// 새로 맺어지는 파티 정보

    EGS_REQUEST_GET_AUTO_PARTY_BONUS_INFO_NOT(906),		// 자동 파티 보너스 정보 요청
    EGS_UPDATE_AUTO_PARTY_BONUS_INFO_NOT(907),			// 자동 파티 보너스 정보

    // 플레이 정보
    EGS_UPDATE_PLAY_STATUS_NOT(908),						// 게임 플레이 상태
    EGS_UPDATE_PARTY_MEMBER_STATUS_NOT(909),				// 파티원들의 상태 정보

    EGS_GAME_START_TIME_COUNT_NOT(910),					// 게임 시작 카운트

    EGS_USE_SKILL_BUFF_IN_PLAY_NOT(911),					// 게임중에 사용되는 스킬에 대한 정보
    EGS_USE_SKILL_BUFF_IN_PLAY_BROAD_NOT(912),			// 게임중에 사용되는 스킬에 대한 정보 브로드 캐스팅
//#endif SERV_BATTLE_FIELD_SYSTEM
    //}}

    //{{ 2012. 04. 11	박세훈	( 복귀 유저 표시(),
//#ifdef SERV_EVENT_RETURN_USER_MARK_SCRIPT
    EGS_CRITERION_EVENT_NOT(913),
//#endif SERV_EVENT_RETURN_USER_MARK_SCRIPT
    //}}

    //{{ 2012. 06. 04	김민성       서버 해킹 유저 체크 요청 응답으로 변경
//#ifdef SERV_SERVER_CHECK_HACK_USER_REQ_ACK
    EGS_SERVER_CHECK_HACK_USER_REQ(914),
    EGS_SERVER_CHECK_HACK_USER_ACK(915),
    EGS_CHECK_HACK_USER_PACKET_REQUEST_NOT(916),
//#endif SERV_SERVER_CHECK_HACK_USER_REQ_ACK
    //}}

    //{{ 2012. 05. 17	박세훈	키보드 맵핑 정보를 DB에서 읽고 쓰기
//#ifdef SERV_KEYBOARD_MAPPING_INFO_RW
    EGS_KEYBOARD_MAPPING_INFO_WRITE_REQ(917),
    EGS_KEYBOARD_MAPPING_INFO_WRITE_ACK(918),
    EGS_KEYBOARD_MAPPING_INFO_NOT(919),
//#endif SERV_KEYBOARD_MAPPING_INFO_RW
    //}}

    //{{ 2012. 05. 25	박세훈	채팅 옵션 정보를 DB에서 읽고 쓰기
//#ifdef SERV_CHAT_OPTION_INFO_RW
    EGS_CHAT_OPTION_INFO_WRITE_REQ(920),
    EGS_CHAT_OPTION_INFO_WRITE_ACK(921),
    EGS_CHAT_OPTION_INFO_NOT(922),
//#endif SERV_CHAT_OPTION_INFO_RW
    //}}
    //{{ 2012. 05. 30	최육사	그노시스 기간 치트
//#ifdef SERV_CASH_SKILL_POINT_DATE_CHANGE
    EGS_ADMIN_CASH_SKILL_POINT_DATE_CHANGE_REQ(923),
    EGS_ADMIN_CASH_SKILL_POINT_DATE_CHANGE_ACK(924),
//#endif SERV_CASH_SKILL_POINT_DATE_CHANGE
    //}}
    //{{ 2012. 06. 13	김민성       선택적 셧다운제
//#ifdef SERV_SELECTIVE_SHUTDOWN_SYSTEM
    EGS_BEFORE_SHUT_DOWN_MESSAGE_NOT(925),
//#endif SERV_SELECTIVE_SHUTDOWN_SYSTEM
    //}}

    //{{ 2012. 07. 02	최육사		대기열 시스템
//#ifdef SERV_WAIT_QUEUE_SYSTEM
    ECH_WAIT_QUEUE_MESSAGE_NOT(926),
//#endif SERV_WAIT_QUEUE_SYSTEM
    //}}

    //{{ 버프 관리 시스템 - 김민성
//#ifdef SERV_SERVER_BUFF_SYSTEM
    EGS_UPDATE_BUFF_INFO_NOT(),						// 버프 정보 갱신 s -> c
    EGS_UPDATE_BUFF_INFO_IN_ROOM_NOT(),				// 방 안에서의 버프 정보
...
//#ifdef SERV_RELATIONSHIP_SYSTEM
    EGS_COUPLE_PROPOSE_REQ(),	// 커플 신청
    EGS_COUPLE_PROPOSE_ACK(),
    EGS_COUPLE_PROPOSE_NOT(),

    EGS_COUPLE_PROPOSE_AGREE_NOT(),	// 커플 신청 응답
    EGS_COUPLE_PROPOSE_RESULT_NOT(),	// 커플 맺기 결과
    EGS_COUPLE_MAKING_SUCCESS_NOT(),	// 커플 맺음 알림

    EGS_RELATIONSHIP_INFO_REQ(),	// 인연 정보 요청(커뮤니티창)
    EGS_RELATIONSHIP_INFO_ACK(),

    EGS_RELATIONSHIP_EFFECT_NOT(),	// 연인 이팩트

    EGS_WEDDING_PROPOSE_REQ(),	// 결혼 신청
    EGS_WEDDING_PROPOSE_ACK(),

    EGS_CHECK_NICK_NAME_REQ(),	// 닉네임 검사
    EGS_CHECK_NICK_NAME_ACK(),

    EGS_WEDDING_ITEM_INFO_REQ(),
    EGS_WEDDING_ITEM_INFO_ACK(),

    EGS_CALL_MY_LOVER_REQ(),	// 연인 소환
    EGS_CALL_MY_LOVER_ACK(),
    EGS_CALL_MY_LOVER_VILLAGE_NOT(),
    EGS_CALL_MY_LOVER_ROOM_NOT(),

    EGS_CALL_MY_LOVER_AGREE_VILLAGE_NOT(),	// 소환 응답
    EGS_CALL_MY_LOVER_STATE_CHANGE_FIELD_NOT(),	// 소환 마을 입장

    EGS_CALL_MY_LOVER_AGREE_ROOM_NOT(),	// 소환 응답
    EGS_CALL_MY_LOVER_JOIN_BATTLE_FIELD_NOT(),	// 소환 필드 입장

    EGS_CALL_MY_LOVER_AGREE_RESULT_NOT(),	// 소환 응답 결과

    EGS_CALL_MY_LOVER_JOIN_BATTLE_FIELD_FAILD_NOT(),	// 소환 응답 이후 입장 실패 알림

    EGS_JOIN_WEDDING_HALL_REQ(),	// 결혼식장 입장 요청
    EGS_JOIN_WEDDING_HALL_ACK(),	// 결혼식장 입장 결과
    EGS_JOIN_WEDDING_HALL_NOT(),	// 결혼식장 입장 알림

    EGS_LEAVE_WEDDING_HALL_REQ(),	// 결혼식장 이탈 요청
    EGS_LEAVE_WEDDING_HALL_ACK(),	// 결혼식장 이탈 결과
    EGS_LEAVE_WEDDING_HALL_NOT(),	// 결혼식장 이탈 알림

    EGS_CHECK_BREAK_UP_REQ(),	// 헤어지기 요청
    EGS_CHECK_BREAK_UP_ACK(),	// 헤어지기 결과

    EGS_BREAK_UP_REQ(),	// 헤어지기 요청
    EGS_BREAK_UP_ACK(),	// 헤어지기 결과
    EGS_BREAK_UP_NOT(),	// 헤어지기 알림 -- 연인에게 전달

    EGS_START_WEDDING_REQ(),	// 결혼식 시작 요청
    EGS_START_WEDDING_ACK(),	// 결혼식 시작 요청 결과

    EGS_START_WEDDING_ASK_REQ(),	// 결혼식 시작 동의 문의
    EGS_START_WEDDING_ASK_ACK(),	// 결혼식 시작 동의 응답
    EGS_START_WEDDING_AGREE_NOT(),	// 결혼식 시작 동의 알림

    EGS_START_WEDDING_NOT(),	// 결혼식 시작 동의 알림

    EGS_CHANGE_LOVE_WORD_REQ(),	// 애칭 변경 요청
    EGS_CHANGE_LOVE_WORD_ACK(),	// 애칭 변경 결과
    EGS_CHANGE_LOVE_WORD_NOT(),	// 애칭 변경 알림

    EGS_ADMIN_CHANGE_COUPLE_DATE_REQ(),	// 커플 맺은 시간 변경
...
//#ifdef	SERV_RIDING_PET_SYSTM// 적용날짜: 2013-04-20
    ...
    EGS_RELEASE_RIDING_PET_NOT(),		// 기간제 라이딩 펫의 만료 패킷
...
//#ifdef SERV_FINALITY_SKILL_SYSTEM	// 적용날짜: 2013-08-01
    EGS_ITEM_EXTRACT_REQ(),
    EGS_ITEM_EXTRACT_ACK(),

    EGS_USE_FINALITY_SKILL_REQ(),
    EGS_USE_FINALITY_SKILL_ACK(),
//#endif // SERV_FINALITY_SKILL_SYSTEM

//#ifdef SERV_BATTLE_FIELD_BOSS// 작업날짜: 2013-10-28	// 박세훈
    EGS_BATTLE_FIELD_BOSS_GATE_OPEN_NOT(),
    EGS_BATTLE_FIELD_BOSS_GATE_CLOSE_NOT(),

    EGS_BOSS_FIELD_INTRUDE_RESTRICTION_REQ(),
    EGS_BOSS_FIELD_INTRUDE_RESTRICTION_ACK(),
    EGS_BOSS_FIELD_CLOSE_PROCESS_NOT(),
    EGS_BOSS_FIELD_RETURN_PROCESS_NOT(),

    EGS_ADMIN_BOSS_FIELD_GATE_OPEN_REQ(),
    EGS_ADMIN_BOSS_FIELD_GATE_OPEN_ACK(),
    EGS_ADMIN_BOSS_FIELD_GATE_CLOSE_NOT(),
    EGS_ADMIN_GET_TOTAL_DANGEROUS_VALUE_REQ(),
    EGS_ADMIN_GET_TOTAL_DANGEROUS_VALUE_ACK(),
    EGS_ADMIN_SET_TOTAL_DANGEROUS_VALUE_REQ(),
    EGS_ADMIN_SET_TOTAL_DANGEROUS_VALUE_ACK(),

    EGS_NPC_UNIT_CREATE_BOSS_NOT(),

    EGS_SOCKET_EXPAND_ITEM_REQ(),
    EGS_SOCKET_EXPAND_ITEM_ACK(),

    EGS_BOSS_FIELD_LOG_NOT(),
...
//#ifdef SERV_GOOD_ELSWORD // 2013-10-29 작업시작 // 우상혁
    EGS_EXPAND_BANK_SLOT_ED_REQ(1141),
    EGS_EXPAND_BANK_SLOT_ED_ACK(1142),
    EGS_GET_NEXT_BANK_ED_REQ(1143), // 은행 업그레이드 비용
    EGS_GET_NEXT_BANK_ED_ACK(1144),
    EGS_EXPAND_INVENTORY_ED_REQ(1145),
    EGS_EXPAND_INVENTORY_ED_ACK(1146),
    EGS_GET_NEXT_INVENTORY_ED_REQ(1147), // 인벤토리 업그레이드 비용
    EGS_GET_NEXT_INVENTORY_ED_ACK(1148),
//#endif

//#ifdef SERV_KOM_FILE_CHECK_ADVANCED
    EGS_KOM_FILE_CHECK_LOG_REQ(1149),
    EGS_KOM_FILE_CHECK_LOG_ACK(1150),
    //#endif SERV_KOM_FILE_CHECK_ADVANCED

//#ifdef SERV_SKILL_PAGE_SYSTEM // 작업날짜: 2013-11-14	// 김현철
    EGS_GET_NEXT_SKILL_PAGE_ED_REQ(1151),
    EGS_GET_NEXT_SKILL_PAGE_ED_ACK(1152),
    EGS_EXPAND_SKILL_PAGE_REQ(1153),
    EGS_EXPAND_SKILL_PAGE_ACK(1154),
    EGS_DECIDE_TO_USE_THIS_SKILL_PAGE_REQ(1155),
    EGS_DECIDE_TO_USE_THIS_SKILL_PAGE_ACK(1156),
...
//#ifdef SERV_ENTRY_POINT
    ...
    EGS_GET_CREATE_UNIT_TODAY_COUNT_ACK(1167),
    EGS_ENTRY_POINT_GET_CHANNEL_LIST_REQ(1168),
    EGS_ENTRY_POINT_GET_CHANNEL_LIST_ACK(1169),
    EGS_ENTRY_POINT_CHANGE_NICK_NAME_REQ(1170),
    EGS_GET_SECOND_SECURITY_INFO_REQ(1171),
    EGS_GET_SECOND_SECURITY_INFO_ACK(1172),
//#endif SERV_ENTRY_POINT

//#ifdef SERV_NAVER_CHANNELING
    EGS_GET_NAVER_ACCESS_TOKEN_REQ(1173),
    EGS_GET_NAVER_ACCESS_TOKEN_ACK(1174),
//#endif SERV_NAVER_CHANNELING

    EGS_CLIENT_EVENT_ID_END(1175),
    ...
    ECH_SECURITY_AUTH_REQ(1176),
    ECH_SECURITY_AUTH_ACK(1177),

    ECH_SECURITY_INFO_NOT(1178),	// 서버에서 보안관련 정보 변경 알려주기 위해 필요
    ...
    EGS_USE_GIANT_CARD_REQ(1179),
    EGS_USE_GIANT_CARD_ACK(1180),

    EGS_EXCHANGE_CASH_REQ(1181),
    EGS_EXCHANGE_CASH_ACK(1182),

    //#ifdef SERV_SUPPORT_SEVERAL_CASH_TYPES
    EGS_BONUS_CASH_EVENT_NOT(1183), // 2011.10.04 lygan_조성욱 //보너스 캐쉬 증정 이벤트를 알리는 패킷
    //#endif //SERV_SUPPORT_SEVERAL_CASH_TYPES
    //}}

    EGS_BILL_PRODUCT_INFO_REQ(1184),
    EGS_BILL_PRODUCT_INFO_ACK(1185),

    EGS_BILL_INVENTORY_INQUIRY_REQ(1186),
    EGS_BILL_INVENTORY_INQUIRY_ACK(1187),

    EGS_BILL_GET_PURCHASED_CASH_ITEM_REQ(1188),
    EGS_BILL_GET_PURCHASED_CASH_ITEM_ACK(1189),

    //#ifdef SERV_GOLD_TICKET
    EGS_CHARGE_POINT_NOT(1190),
    ...
    ECH_GET_SERVERGROUP_LIST_REQ(2774),
    ECH_GET_SERVERGROUP_LIST_ACK(2775),
    ECH_GET_SERVERGROUP_LIST_NOT(2776),
...
//#endif //SERV_MANUFACTURE_PERIOD_FIX
    ...
    EGS_GET_MY_INVENTORY_SPLIT_REQ(1471),
    EGS_GET_MY_INVENTORY_SPLIT_ACK(1472),

    EGS_UNK_3_REQ(1850),
    EGS_UNK_3_ACK(1851),
    EGS_UNK_3_ACK_1(1207),
    EGS_UNK_3_ACK_2(1208),
    EGS_UNK_3_ACK_3(1209),
    EGS_UNK_3_ACK_4(1725),
    ...
    EGS_UNK_1552_NOT(1552),
    EGS_UNK_1616_NOT(1616),
    EGS_UNK_1676_NOT(1676),
    EGS_UNK_2873_NOT(2873),
    EGS_UNK_2393_NOT(2393),
    EGS_UNK_2727_NOT(2727),
    EGS_UNK_1206_NOT(1206),
    EGS_UNK_1918_NOT(1918),
    EGS_UNK_1371_NOT(1371),
    EGS_UNK_2855_NOT(2855),
    EGS_UNK_1992_NOT(1992),
    EGS_UNK_1994_NOT(1994),
    EGS_UNK_792_NOT(792),
    EGS_UNK_1431_NOT(1431),
    EGS_UNK_1884_NOT(1884),
    EGS_UNK_2882_NOT(2882),
    EGS_UNK_1687_NOT(1687),
    EGS_UNK_2064_NOT(2064),
    EGS_UNK_2854_NOT(2854),
    EGS_UNK_1625_NOT(1625),

    ETR_REG_UID_NOT(2000),

    ECH_START_REQ(2810),
    ECH_START_ACK(2811),

    EGS_STATE_CHANGE_FIELD_UNK(928),

    E_XIGNCODE_HEART_BEAT(2802),
